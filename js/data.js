...
const qnaList = [
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. "오늘 등교 같이할래?" 친구에게 함께 가자고 당장 연락한다.', type: [0, 1, 3] },
    ],
  },
  {
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 선배미 뿜뿜!! 꿀팁을 전수하며 이야기를 나눈다.', type: [0, 1, 3] },
      { answer: 'b. 길만 알려주고 빠른 걸음으로 먼저 간다.', type: [0, 2] },
      { answer: 'c. 뒤에서 잘 찾아가나 힐끔힐끔 본다.', type: [2] },
    ],
  },
  {
    q:
    ...
    a: [
      ...
      { answer: 'b. 교수님께 인간적으로도 학문적으로도 배울 점 엄청 많아! 학점은 조금 아쉽긴 했는데 과정이 좋았어!', type: [2, 3] },
      { answer: 'c. 너무 궁금하던 강의야! ', type: [0, 2] },
    ],
  },
  {
    q:
...
const infoList = [
  {
    ...
    descTitle2:
      '당신의 예술을 펼쳐라✨',
    desc2:
      '공연분과<br/>예창분과<br/>신규분과(커버댄스, 음악컨텐츠, 뮤지컬)',
  },
  {
  ...
  },
  {
    ...
    descTitle2:
      '당신의 연구를 힘께하라✨',
    desc2:
      '학술분과<br/>연구분과<br/>신규분과(it창업, it, 비즈니스)',
