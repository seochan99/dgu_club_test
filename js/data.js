...
const infoList = [
  ...
  },
  {
    ...
    desc2:
      'COURTIST(농구), L.A.E(야구), 명궁(국궁), DUTC(테니스), 검도부(검도), 선무부(태권도), FC TOTO(축구), 기우회(바둑), 터스커스(미식축구), DUST(스키), 무법(극진공수도), 산악부(트레킹클라이밍), 동굴탐험연구회(동굴탐험), 바람소리(페러글라이딩), 수중탐험연구회(스킨스쿠버)<br/>FC엘레펜터(여자축구)',
  },
  {
